...
<html>
<head>
	<title>Form Tambah Data Jabatan</title>
	...
	<div class="container">
		...
		<section class="middle">
			...
			<!-- Main body-->
				...
				<h1 style="margin-left:450px;">Form Tambah Data Jabatan</h1>
					<div class="container-form">
						<form method="post" action="proses/tambah_jabatan.php">
							<label style="color: black">ID Jabatan: </label><br>
							<input id="input" type="text" name="id_jabatan" placeholder="Masukkan ID Jabatan" required><br><br>
							<label style="color: black">Jabatan: </label><br>
							<input id="input" type="text" name="jabatan" placeholder="Masukkan Jabatan" required><br><br>
							<label style="color: black">Gaji Minimal: </label><br>
							<input id="input" type="text" name="min_gaji" placeholder="Masukkan Min Gaji" required><br><br>
							<label style="color: black">Gaji Maksimal: </label><br>
							<input id="input" type="text" name="max_gaji" placeholder="Masukkan Max Gaji" required><br><br>
