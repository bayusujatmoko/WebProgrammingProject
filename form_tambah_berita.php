			...
			<!-- Main body-->
				<div class="kotak" align="left">
					...
					<div class="container-form">
						<form method="post" action="proses/tambah_berita.php" enctype="multipart/form-data">
							<label style="color: black">Kode : </label><br>
							<input id="input" type="text" name="kode" placeholder="Masukkan Kode Berita" required><br><br>
							<label style="color: black">Gambar Berita: </label><br>
							<input type="file" name="img" required><br><br>
							<label style="color: black">Judul Berita : </label><br>
							<input id="input" type="text" name="judul" placeholder="Masukkan Judul Berita" required><br><br>
							...
							<textarea type="text" name="informasi" placeholder="Masukkan Informasi Berita" required></textarea>
