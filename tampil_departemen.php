						...
						<?php
							...
							{ ?>
								<tr>
									...
									<td>
									<a id="btn-submit" href="form_edit_departemen.php?id_departemen=<?php echo $departemen['id_departemen']; ?>">Edit</a>
									<a id="btn-submit" href="proses/hapus_departemen.php?id_departemen=<?php echo $departemen['id_departemen']; ?> " onclick="return klikHapus();">Hapus</a>
									</td>
								</tr>
								<?php $i++;
							}
