...
<html>
<head>
	<title>Form Tambah Data Departemen</title>
	...
	<div class="container">
		...
		<section class="middle">
			...
			<!-- Main body-->
				...
				<h1 style="margin-left:450px;">Form Tambah Data Departemen</h1>
					<div class="container-form">
						<form method="post" action="proses/tambah_departemen.php">
							<label style="color: black">ID Departemen: </label><br>
							<input id="input" type="text" name="id_departemen" placeholder="Masukkan ID Departemen" required><br><br>
							<label style="color: black">Nama Departemen: </label><br>
							<input id="input" type="text" name="nama_departemen" placeholder="Masukkan Nama Departemen" required><br><br>
